...
public class Game3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button Back = (Button) findViewById(R.id.Back3ID);
        ...
        Leaderboard.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Leaderboard3.class);
            startActivity(intent);
        });
        sHistory.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), SHistory3.class);
            startActivity(intent);
        });
